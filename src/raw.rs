...
use crate::state::*;
use crate::utils::{abort, abort_on_panic, const_max, extend};
use crate::Runnable;
    ...
    S: Fn(Runnable),
{
    ...
    const TASK_LAYOUT: TaskLayout = {
        ...
        let size_union = const_max(layout_f.size(), layout_r.size());
        let align_union = const_max(layout_f.align(), layout_r.align());
